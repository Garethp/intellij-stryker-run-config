...
class LicencingManager {
    private val PRODUCT_CODE = "PSTRKER"
...
//            // the license is obtained via JetBrainsAccount or entered as an activation code
    ...
    private fun isKeyValid(key: String): Boolean {
        ...
        try {
            ...
            val licenseBytes: ByteArray =
                Base64.getMimeDecoder().decode(licensePartBase64.toByteArray(StandardCharsets.UTF_8))
    ...
    private val TIMESTAMP_VALIDITY_PERIOD_MS = 1 * HOUR // configure period that suits your needs better
