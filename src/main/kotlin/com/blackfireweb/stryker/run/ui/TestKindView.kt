...
abstract class TestKindView {
    abstract fun getComponent(): JComponent

    abstract fun resetFrom(settings: StrykerRunConfig.StrykerRunSettings)
    abstract fun applyTo(settings: StrykerRunConfig.StrykerRunSettings)
}

class DirectoryKindView(project: Project) : TestKindView() {
...
class TestView(project: Project) : TestKindView() {
    private val myTestFileView: SpecKindView = SpecKindView(project)
